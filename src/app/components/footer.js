        ...
        <>
            <footer className="text-gray-600 body-font font-Poppins  ">
                <div className="container px-5 py-4 mx-auto flex items-center sm:flex-row flex-col dark:bg-gray-800 rounded-xl ">
                    ...
                    <div className=" flex text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2  sm:mt-0 mt-4text-base dark:text-slate-400">Copyright © 2023
                    ...
                    <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start cursor-pointer text-xl">
                        <div className="ml-3 text-gray-500 cursor-pointer ">
                            <Link href="https://www.facebook.com/profile.php?id=100090786762444" target='_blank'><i className='py-2 h-5 text-xl text-green-600 dark:text-white'>{BsGithub()}</i></Link>
                        ...
                        <div className="ml-3 text-gray-500 cursor-pointer">
                            <Link href="https://api.whatsapp.com/qr/J5PPENYRPZJKC1?autoload=1&app_absent=0" target='_blank'><i className='py-2 text-xl text-green-600 dark:text-white'>{IoLogoWhatsapp()}</i></Link>
