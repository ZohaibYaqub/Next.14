          ...
          <div className="flex flex-wrap -m-4">
            ...
            <div className="p-4 md:w-1/3">
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden shadow-md">
                ...
                <div className="p-6">
                  <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">FREE COURSE</h2>
                  <h1 className="title-font text-lg font-medium text-gray-900 mb-3">Mobile App Development</h1>
            ...
            <div className="p-4 md:w-1/3">
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden shadow-md">
                ...
                <div className="p-6">
                  <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">FREE COURSE</h2>
                  <h1 className="title-font text-lg font-medium text-gray-900 mb-3">Artificial Intelligence (AI)</h1>
